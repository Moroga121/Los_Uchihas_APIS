...
namespace USR5_Login.Repository
{
    public class LoginRepository
    {
        ...
        public async Task<Login> ValidarUsuarioAsync(Login login)
        {
            ...
            parametros.Add("p_Identificacion", dbType: DbType.String, size: 22, direction: ParameterDirection.Output);
            ...
            login.Identificacion = parametros.Get<string>("p_Identificacion");
